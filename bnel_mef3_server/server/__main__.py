...
def main():
    ...
    print(f"Starting gRPC MEF3 server on port {port} with FileManager config: n_prefetch={n_prefetch}, cache_capacity_multiplier={cache_capacity_multiplier}, max_workers={max_workers}, n_process_workers={n_process_workers}")
